...
mkdir Australia/VIC
mkdir Australia/WA
mv ipvanish-AU-Adelaide-adl-* Australia/SA
mv ipvanish-AU-Brisbane-bne-* Australia/QLD
mv ipvanish-AU-Melbourne-mel-* Australia/VIC
mv ipvanish-AU-Perth-per-* Australia/WA
mv ipvanish-AU-Sydney-syd-* Australia/NSW

cd $DIR/Australia/QLD
